...
namespace Zermelo.API.Endpoints
{
    ...
    public class LocationsEndpoint : EndpointBase
    {
        ...
        public async Task<IEnumerable<Location>> GetAllAsync(List<string> fields = null)
        {
        ...
        public async Task<Location> GetSingleById(long id, List<string> fields = null)
        {
        ...
        public async Task<IEnumerable<Location>> GetByCustomUrlOptionsAsync(Dictionary<string, string> urlOptions, List<string> fields = null)
        {
            return await GetByCustomUrlOptionsAsync<Location>(_endpoint, urlOptions, fields);
        }
    }
}
